...
export default function TermsAndConditions() {
  return <main className="readable-surface page-shell my-10 max-w-4xl py-10 sm:my-16 sm:py-14">
    ...
    <div className="mt-8 space-y-7 text-[.95rem] leading-7 text-stone-700">
      ...
      <section><h2 className="font-serif text-2xl font-semibold text-forest">Journal messaging program</h2><p className="mt-2">By separately choosing to opt in, you agree to receive recurring automated Road &amp; Country journal alerts by SMS or MMS at the mobile number you provide. Messages may include a trip day number, journal hook, image, and link to a new entry. Message frequency varies. Message and data rates may apply. Consent to text messages is not a condition of purchase or of receiving email-only updates.</p></section>
      <section><h2 className="font-serif text-2xl font-semibold text-forest">Stopping messages and getting help</h2><p className="mt-2">Reply STOP to any text message to unsubscribe. After opting out, you may receive one final confirmation message. Reply HELP for assistance or email <a className="font-semibold text-[#244f76] underline" href="mailto:contact@curtisroadtrip.com">contact@curtisroadtrip.com</a>. You may rejoin later by submitting the website form again or using a supported opt-in keyword.</p></section>
      ...
      <section><h2 className="font-serif text-2xl font-semibold text-forest">Contact</h2><p className="mt-2">Questions about these terms or the journal messaging program may be sent to <a className="font-semibold text-[#244f76] underline" href="mailto:contact@curtisroadtrip.com">contact@curtisroadtrip.com</a>.</p></section>
    </div>
