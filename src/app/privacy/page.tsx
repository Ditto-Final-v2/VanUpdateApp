...
export default function PrivacyPolicy() {
  return <main className="readable-surface page-shell my-10 max-w-4xl py-10 sm:my-16 sm:py-14">
    ...
    <p className="mt-2 text-sm text-stone-500">Effective July 26, 2026</p>
    <div className="mt-8 space-y-7 text-[.95rem] leading-7 text-stone-700">
      ...
      <section><h2 className="font-serif text-2xl font-semibold text-forest">Mobile information and messaging consent</h2><p className="mt-2 font-semibold">Mobile phone numbers, SMS/MMS opt-in data, and messaging consent will not be sold, rented, shared, or transferred to third parties or affiliates for marketing or promotional purposes.</p><p className="mt-2">The above excludes text messaging originator opt-in data and consent; this information will not be shared with any third parties, except service providers acting solely on behalf of Curtis Road Trip (Road &amp; Country) to deliver the requested messaging service. Message frequency varies. Message and data rates may apply. Reply STOP to unsubscribe from text messages or HELP for assistance.</p></section>
      ...
      <section><h2 className="font-serif text-2xl font-semibold text-forest">Website analytics</h2><p className="mt-2">The site uses Vercel Web Analytics to understand aggregate website traffic, including pages viewed, referring sites, approximate general location, browser, operating system, and device type. Vercel Web Analytics does not use third-party cookies and does not associate these page-view statistics with a personally identifiable visitor. Administrative, login, confirmation, and unsubscribe pages are excluded from analytics.</p></section>
